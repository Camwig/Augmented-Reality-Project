...
AARPlaneActor::AARPlaneActor()
{
	...
	PlanePolygonMeshComponent->bNavigationRelevant = true;
	PlanePolygonMeshComponent->bHasCustomNavigableGeometry = EHasCustomNavigableGeometry::Yes;
...
void AARPlaneActor::Tick(float DeltaTime)
{
	...
	case EARTrackingState::Tracking:
		if (bShouldRender) PlanePolygonMeshComponent->SetVisibility(true);
		break;
